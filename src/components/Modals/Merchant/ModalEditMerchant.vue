...
const updateMerchant = async () => {
  ...
  const confirm = await Swal.fire({
    title: "Are you sure?",
    text: "Do you want to edit this merchant?",
    icon: "question",
...
watch(
  ...
  (newMerchant) => {
    ...
    merchantName.value = newMerchant.merchantName || "";
    address.value = newMerchant.address || "";
    email.value = newMerchant.email || "";
    contactPerson.value = newMerchant.contactPerson || "";
    contactNumber.value = newMerchant.contactNumber || "";
    area.value = newMerchant.area || "";
    paymentMode.value = newMerchant.paymentMode || "";
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div>
          <h2 class="text-lg font-semibold text-gray-900">Edit Merchant</h2>
        </div>
        <button
          @click="$emit('close')"
