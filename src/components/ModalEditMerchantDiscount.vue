...
const editMerchantDiscount = async () => {
  errorMsg.value = "";
  ...
  try {
    ...
    const response = await fetch(
      `${apiBase}/merchants/${props.merchantDiscount.merchantDiscountId}/discounts/`,
      {
        method: "PUT",
        headers: {
    ...
    if (!response.ok) {
      ...
      throw new Error(
        errorData.message || "Failed to update Merchant Discount",
      );
    }
    ...
    console.error(err);
    errorMsg.value = "Failed to update Merchant Discount.";
  } finally {
...
onMounted(() => {
  discountName.value = props.merchantDiscount.discountName;
  routeId.value = props.merchantDiscount.routeId;

  if (props.merchantDiscount.discountType === "percentage") {
    discountType.value = "percentage";
    percentageValue.value = props.merchantDiscount.discountValue;
    fixedValue.value = "";
  } else {
    discountType.value = "fixed";
    fixedValue.value = props.merchantDiscount.discountValue;
    percentageValue.value = "";
  }
});
</script>
...
<template>
  ...
  >
    ...
    >
      ...
      <!-- FORM CONTENT  -->
      <form
        @submit.prevent="editMerchantDiscount"
