<script setup>
import { Move, MoveLeft, Search, Users } from "lucide-vue-next";
import { ref, computed, onMounted } from "vue";
import { useRouter } from "vue-router";

import sampleData from "../Refunds/Modules/walkin-data.json";
...
<template>
  <div class="min-h-full">
    ...
    <div class="border border-gray-300 bg-white m-5 rounded-lg">
      <div class="px-4 py-3 border-b border-gray-200 gap-3 flex flex-col">
        <div class="flex justify-between">
          <h2 class="text-lg font-medium text-gray-900">Teller Refunds</h2>
          <button
            @click="goToBooking"
        ...
        <div v-else-if="filteredBookings.length > 0" class="overflow-x-auto">
          <table class="min-w-full table-fixed divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                <th class="w-12 px-4 py-3 text-left text-xs text-gray-500">
                  #
                </th>
